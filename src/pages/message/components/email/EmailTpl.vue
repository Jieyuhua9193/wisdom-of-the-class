<template>
		<div class="email-tpl">
				<div class="mix over category-newsletters" style="display: inline-block;">
						<ul class="photo-grid newsletters">
								<li>
										<div class="target">
												<figure>
														<div class="img_wrapper">
																<div class="draw-device browser" id="Foodies-browser">
